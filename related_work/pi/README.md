...
**准备采访 PI：** [60 分钟提纲：12 个必问](12_pi_interview_guide.md)。逐题对应客户原问题，全部需求进入必问；先问主问，漏答的要点再补齐。

## 核心主线

**先查具体做过什么：** [PI 工业任务](../SCENARIOS_BY_MODEL.md#pi-industry) / [PI 家庭任务](../SCENARIOS_BY_MODEL.md#pi-home)。工业重点查纸箱成型与工厂包装；家庭重点查衣物、厨房、卧室、备菜与清洁。各行注明专项训练、新环境测试和语言指导等条件；咖啡制作另列为商业服务。
