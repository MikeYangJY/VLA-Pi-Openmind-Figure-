...
- [1. 一张表分清三个名字](#1-一张表分清三个名字)
- [2. π0.6：先把基础 VLA 说清楚](#2-π06先把基础-vla-说清楚)
- [3. π0.6*：怎样把“经历过”变成“学得更好”](#3-π06怎样把经历过变成学得更好)
- [4. π0.6-MEM：学会记住哪些过去信息](#4-π06-mem学会记住哪些过去信息)
- [5. 用“把三个杯子放进柜子”串起来](#5-用把三个杯子放进柜子串起来)
- [6. 与 π0.7、openpi 学习范围的关系](#6-与-π07openpi-学习范围的关系)
...
[前一篇：KI](04_knowledge_insulation.md) · [接着读：RECAP](05_recap.md) · [返回PI入口](README.md)
<!-- reading-footer-end -->
