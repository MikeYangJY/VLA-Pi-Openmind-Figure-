...
<!-- reading-nav-start -->
[首页](../../README.md) · [机制入口](../MECHANISMS.md) · [按问题查找](../FIND_BY_QUESTION.md)
<!-- reading-nav-end -->
...
- [1. 哪些能确认，哪些不能归到 PI 名下？](#1-哪些能确认哪些不能归到-pi-名下)
- [2. 先把一条机器人记录看清楚](#2-先把一条机器人记录看清楚)
- [3. Kinematics sanity check：检查运动记录是否说得通](#3-kinematics-sanity-check检查运动记录是否说得通)
- [4. 多摄像头状态变化验证成功：从“变化”到“目标成立”](#4-多摄像头状态变化验证成功从变化到目标成立)
- [5. 视觉归一化：沿 openpi 的真实代码看一遍](#5-视觉归一化沿-openpi-的真实代码看一遍)
- [6. 三个概念的联系与区别](#6-三个概念的联系与区别)
- [7. 访谈时把问题问到可验证的程度](#7-访谈时把问题问到可验证的程度)
- [8. 小自测](#8-小自测)
...
[接着读：访谈准备](../INTERVIEW_PREP.md) · [返回机制入口](../MECHANISMS.md)
<!-- reading-footer-end -->
