...
# 定位：可跳过｜π0-FAST自回归动作分支；保留上游文件以维持完整依赖结构。
# 阅读顺序：学习π0/π0.5连续动作主线时可跳过本文件。
# 重点边界：本文件的token交叉熵和AR采样不能当成π0/π0.5的flow采样。
...
# 【make_attn_mask】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
...
# 【left_to_right_align】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
@jax.vmap
...
# 【put_along_last_axis】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
...
# 【Pi0FASTConfig】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
...
class Pi0FASTConfig(_model.BaseModelConfig):
    ...
    # 【Pi0FASTConfig.model_type】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
    @property
    @override
    def model_type(self) -> _model.ModelType:
        return _model.ModelType.PI0_FAST

    # 【Pi0FASTConfig.create】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
    @override
    def create(self, rng: at.KeyArrayLike) -> "Pi0FAST":
        return Pi0FAST(self, rngs=nnx.Rngs(rng))

    # 【Pi0FASTConfig.inputs_spec】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
    @override
    ...
    # 【Pi0FASTConfig.get_freeze_filter】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
...
# 【Pi0FAST】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
class Pi0FAST(_model.BaseModel):
    # 【Pi0FAST.__init__】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
    ...
    # 【Pi0FAST.embed_inputs】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
    @at.typecheck
    def embed_inputs(
    ...
    # 【Pi0FAST.compute_loss】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
    @override
    def compute_loss(
    ...
    # 【Pi0FAST.sample_actions】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
    @override
    def sample_actions(
        self,
        rng: at.KeyArrayLike,
        ...
        *,
        ...
        # 【Pi0FAST.sample_actions.step】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
        def step(carry):
        ...
        # 【Pi0FAST.sample_actions.cond】此符号属于π0/π0.5主线以外的上游分支。本轮可跳过；保留原实现和英文说明供依赖完整性及将来查询。
        def cond(carry):
